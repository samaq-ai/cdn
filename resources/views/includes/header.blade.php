                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('profile') }}"><span class="oi oi-person"></span> Profile</a>
                                <a class="dropdown-item" href="{{ route('profile') }}"><span class="oi oi-dashboard"></span> Dashboard</a>
