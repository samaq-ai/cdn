...
<head>
  ...
  <title>
      {{ __('Sama Business Services by SBS') }}
  </title>
...
<body class="">
  <div class="wrapper ">
    ...
    -->
      <div class="logo">
        <a href="http://سما-الاعمال.السعودية/" class="simple-text logo-normal">
          تیم خلاق
        </a>
      </div>
        ...
        <footer class="footer">
          <div class="container-fluid">
            <nav class="float-left">
              <ul>
                <li>
                  <a href="http://سما-الاعمال.السعودية/">
                    تیم خلاق
                  </a>
                </li>
                <li>
                  <a href="http://سما-الاعمال.السعودية/presentation">
                    درباره ما
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="http://سما-الاعمال.السعودية/license">
                    اجازه نامه
                  </a>
                </li>
              </ul>
            ...
            <div class="copyright float-right">
              ...
              <a href="http://سما-الاعمال.السعودية/" target="_blank">تیم خلاق</a> برای وب بهتر.
            </div>
          </div>
        </footer>
      </div>
